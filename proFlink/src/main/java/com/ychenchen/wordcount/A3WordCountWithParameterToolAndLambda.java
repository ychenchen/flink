 ...
 */
public class A3WordCountWithParameterToolAndLambda {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WordAndCount> wordCount = data.flatMap((FlatMapFunction<String, WordAndCount>) (s, collector) -> {
        ...
        wordCount.print();
        env.execute("wordCountWithPOJOAndLambda");
    }
}
