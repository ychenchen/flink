 ...
 */
public class A4WordCountWithParameterToolAndMethod {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WordAndCount> wordCount = data.flatMap(new SplitWord()).keyBy("word").sum("count");
        wordCount.print();
        env.execute("wordCountWithPOJOAndMethod");
    }
